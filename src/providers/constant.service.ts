...
var minTitleLength: number = 10;
var maxTitleLength: number = 60;

var minCommentLength: number = 10;

var minAdressLength: number = 10;
var maxAdressLength: number = 60;

var minPhoneLength: number = 10;
var maxPhoneLength: number = 13;

var minIdentifyCardLength: number = 9;
var maxiIdentifyCardLength: number = 11;

var minDescriptionLength: number = 20;
...
export const CONSTANT = Object.freeze({
  ...
  SERVER: {
    ...
    APIS: {
      ...
      HOUSE_DETAIL(rentingId: number): string {
  ...
  STRING_CANCEL: 'Hủy',
  STRING_SELECT: 'Chọn',
  STRING_RESET_FILTER: 'Đã đặt lại bộ lọc về mặc định',
  STRING_SAVE: 'Lưu',
  WAITING: 'Xin đợi trong giây lát...',
  UPDATING: 'Đang cập nhật thông tin, vui lòng đợi trong giây lát...',
  QUESTION_SAVE: 'Bạn có muốn lưu thay đổi?',
  CLOSE_APP: "Đóng ứng dụng",
  ASK_CLOSE_APP: "Bạn muốn đóng ứng dụng?",
  CLICKED_TO_CLOSE_APP: "Nhấn phím trở về thêm lần nữa để đóng ứng dụng",
  ...
  EVENTS_NAME: {
    ...
    DATA_STORAGE_CHANGED: 'DataStorage:changed',
